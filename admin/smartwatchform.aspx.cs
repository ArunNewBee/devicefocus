...
public partial class admin_smartwatchform : System.Web.UI.Page
{
    SqlDataReader dr;
        ...
        if (FileUpload1.HasFile)
        {
            if (FileUpload1.PostedFile.ContentType == "image/jpeg" || FileUpload1.PostedFile.ContentType == "image/png")
            {
               ...
               sql = "update regid set regid='" + strreg + "'";
                ...
                string cmdString = @"Insert smartwatch(regno,brand,modelname,title,dialshape,strapcolor,waterresistant,displaysize,resolution,os,osversion,expmem,intmem,bluetooth,bluetoothversion,callfunction,gps,wifi,messaging,primarycam,othercam,microphone,audioformat,videoformat,speaker,datetimedisplay,alarm,compass,calender,altimeter,chronograph,sensors,otherfeatures,itemsinside,compos,compdevice,price,pic,youtubelink,source,verified) values('" + strreg + "','" + ddlbrand.SelectedItem + "','" + txtmodel.Text + "','" + ddlbrand.SelectedItem + " " + txtmodel.Text + "','" + ddldial.SelectedItem + "','" + txtstrapcolor.Text + "','" + ddlwater.SelectedItem + "','" + txtdisp.Text + "','" + txtreso.Text + "','" + txtos.Text + "','" + txtosver.Text + "','" + txtexpmem.Text + "','" + txtintmem.Text + "','" + ddlblu.SelectedItem + "','" + txtbluver.Text + "','" + ddlcall.SelectedItem + "','" + ddlgps.SelectedItem + "','" + ddlwifi.SelectedIndex + "','" + ddlmsg.SelectedItem + "','" + txtpcam.Text + "','" + txtotrcam.Text + "','" + ddlmicro.SelectedItem + "','" + txtaudio.Text + "','" + txtvideo.Text + "','" + ddlspkr.SelectedItem + "','" + ddldate.SelectedItem + "','" + ddlalarm.SelectedItem + "','" + ddlcompass.SelectedItem + "','" + ddlcalender.SelectedItem + "','" + ddlalti.SelectedItem + "','" + ddlchrono.SelectedItem + "','" + txtsensor.Text + "'','" + txtotrfeatures.Text + "','" + txtitminside.Text + "','" + txtcompos.Text + "','" + txtcompdevice.Text + "','" + txtprice.Text + "','../pictures/" + fileName1 + "','" + txtyt.Text + "','" + txtsource + "','yes')";
