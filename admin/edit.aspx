...
<body>
    ...
    <div class="tab">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            DeleteCommand="DELETE FROM [smartphone] WHERE [regno] = @regno" 
            InsertCommand="INSERT INTO [smartphone] ([regno], [brand], [modelcode], [releasedate], [formfactor], [dimension], [weight], [batcap], [removablebat], [colors], [SAR], [screensize], [touchscreen], [touchscreentype], [resolution], [pixelperinch], [dispcolor], [processor], [RAM], [intstorage], [expstorage], [rearcam], [flash], [frontcam], [osver], [os], [skin], [javasupport], [browser], [wifi], [wifistnd], [GPS], [bluetooth], [NFC], [bluetoothprofiles], [DLNA], [wifidir], [MHL], [HDMI], [headphone], [FM], [USB], [noofsim], [simtype], [infra], [twog], [threeg], [fourg], [compass], [proxi], [accmtr], [amplightsensor], [gyroscope], [baromtr], [temp], [rate], [youtubelink], [source], [verified]) VALUES (@regno, @brand, @modelcode, @releasedate, @formfactor, @dimension, @weight, @batcap, @removablebat, @colors, @SAR, @screensize, @touchscreen, @touchscreentype, @resolution, @pixelperinch, @dispcolor, @processor, @RAM, @intstorage, @expstorage, @rearcam, @flash, @frontcam, @osver, @os, @skin, @javasupport, @browser, @wifi, @wifistnd, @GPS, @bluetooth, @NFC, @bluetoothprofiles, @DLNA, @wifidir, @MHL, @HDMI, @headphone, @FM, @USB, @noofsim, @simtype, @infra, @twog, @threeg, @fourg, @compass, @proxi, @accmtr, @amplightsensor, @gyroscope, @baromtr, @temp, @rate, @youtubelink, @source, @verified)" 
            SelectCommand="SELECT * FROM [smartphone] WHERE ([regno] = @regno)" 
            UpdateCommand="UPDATE [smartphone] SET [brand] = @brand, [modelcode] = @modelcode, [releasedate] = @releasedate, [formfactor] = @formfactor, [dimension] = @dimension, [weight] = @weight, [batcap] = @batcap, [removablebat] = @removablebat, [colors] = @colors, [SAR] = @SAR, [screensize] = @screensize, [touchscreen] = @touchscreen, [touchscreentype] = @touchscreentype, [resolution] = @resolution, [pixelperinch] = @pixelperinch, [dispcolor] = @dispcolor, [processor] = @processor, [RAM] = @RAM, [intstorage] = @intstorage, [expstorage] = @expstorage, [rearcam] = @rearcam, [flash] = @flash, [frontcam] = @frontcam, [osver] = @osver, [os] = @os, [skin] = @skin, [javasupport] = @javasupport, [browser] = @browser, [wifi] = @wifi, [wifistnd] = @wifistnd, [GPS] = @GPS, [bluetooth] = @bluetooth, [NFC] = @NFC, [bluetoothprofiles] = @bluetoothprofiles, [DLNA] = @DLNA, [wifidir] = @wifidir, [MHL] = @MHL, [HDMI] = @HDMI, [headphone] = @headphone, [FM] = @FM, [USB] = @USB, [noofsim] = @noofsim, [simtype] = @simtype, [infra] = @infra, [twog] = @twog, [threeg] = @threeg, [fourg] = @fourg, [compass] = @compass, [proxi] = @proxi, [accmtr] = @accmtr, [amplightsensor] = @amplightsensor, [gyroscope] = @gyroscope, [baromtr] = @baromtr, [temp] = @temp, [rate] = @rate, [youtubelink] = @youtubelink, [source] = @source, [verified] = @verified WHERE [regno] = @regno">
            <DeleteParameters>
