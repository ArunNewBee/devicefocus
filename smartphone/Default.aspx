<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="smartphone_Default" MasterPageFile="~/smartphone/site.master" %>
...
<asp:DropDownList ID="DropDownList1" runat="server" CssClass="ddldef" 
        ...
        <asp:ListItem Value="7">Rs.40,000 - Rs.45,000</asp:ListItem>
        <asp:ListItem Value="8">Rs.45,000 - Rs.50,000</asp:ListItem>
...
<asp:DataList ID="DataList1" runat="server" DataKeyField="regno" Width="100%"  RepeatColumns="4" RepeatDirection="Horizontal" style="vertical-align:top;">
        <ItemTemplate>
         <div class="sep1">
       <a href='<%# Eval("regno","profile.aspx?strReg={0}#list") %>'>  
         <img src='<%# Eval("pic") %>' alt='' style="width:100%;"/>
    <p class="listpara" style="text-align:center;width:90%;margin-left:auto;margin-right:auto;">
        <asp:Label ID="Label1" runat="server" Text='<%# Eval("modelcode") %>' style="overflow:hidden;"></asp:Label></p> 
        </a></div>
  ...
  <p class="subsec">Popular Mobile Brands</p>
  <div class="table">
