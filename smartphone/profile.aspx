<%@ Page Language="C#" AutoEventWireup="true" CodeFile="profile.aspx.cs" Inherits="smartphone_profile" MasterPageFile="~/smartphone/site.master" %>
...
<div class="front1">
<p class="caption" style="font-size:30px;color:#ED1652;margin-bottom:20px;margin-top:20px;">
    <asp:Label ID="lblalt" runat="server" Font-Bold="True"></asp:Label>
    </p>
    <div class="det">
    <ul>
    ...
    <li><a href="#ifrm">video</a></li>
    </ul>
    </div>
    <div class="table blk" id="over">
    <div class="pics">
...
<asp:TextBox ID="txtContactsSearch" runat="server" 
        ontextchanged="txtContactsSearch_TextChanged" AutoPostBack="true" CssClass="aut" placeholder="&nbsp;&nbsp;Enter name of Smartphone"></asp:TextBox>
...
<div id="spec">
    <asp:FormView ID="FormView1" runat="server" DataKeyNames="regno" style="width:100%"
        ...
        <ItemTemplate>
        <p class="spec" style="margin-top:40px;margin-bottom:10px;">Specification</p>
        <div class="table blk">
        <div class="side1">
        <p class="specitem">
        General
        ...
        <td>
              <asp:Label ID="Label19" runat="server" Text='<%# Bind("os") %>' />
        </td>
        </tr>
